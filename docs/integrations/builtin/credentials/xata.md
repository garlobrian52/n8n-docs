...
Refer to [Xata's documentation](https://xata.io/docs/getting-started/installation) for more information about the service.
...
- The **Database Endpoint**: The Workspace API requires that you identify the database you're requesting information from using this format: `https://{workspace-display-name}-{workspace-id}.{region}.xata.sh/db/{dbname}`. Refer to [Xata's API documentation](https://xata.io/docs/getting-started/installation) for more information.
...
- An **API Key**: To generate an API key, go to [**Account Settings**](https://app.xata.io/settings) and select **+ Add a key**.